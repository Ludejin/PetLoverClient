...
class LogConfigurator {
    ...
    /**
     * @param fileName  Name of the log file
     * @param rootLevel Log level for the root com.github.moduth.ext.component.logger
     */
    ...
    /**
     * Sets the level of com.github.moduth.ext.component.logger with name <code>loggerName</code>.
