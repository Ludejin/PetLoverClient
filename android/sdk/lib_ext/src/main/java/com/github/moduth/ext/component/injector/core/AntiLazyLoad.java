package com.github.moduth.ext.component.injector.core;
 ...
 * (2) keep it as an only class in "com.github.moduth.ext.component.injector.core" package <br>
 * (3) build it into extra dex, load it in code.<br>
 *
 * @see {@link com.github.moduth.ext.component.injector.SystemClassLoaderInjector}
 * <p>
